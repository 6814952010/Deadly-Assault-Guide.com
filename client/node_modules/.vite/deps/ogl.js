...
var Vec2 = class _Vec2 extends Array {
  ...
  squaredDistance(v) {
    ...
    else return squaredLength3(this);
  }
  negate(v = this) {
    negate2(this, v);
    return this;
  ...
  intersectBounds(meshes) {
    ...
    meshes.forEach((mesh) => {
      ...
      if (mesh.geometry.raycast === "sphere") {
        distance3 = this.intersectSphere(mesh.geometry.bounds, origin, direction);
      } else {
        distance3 = this.intersectBox(mesh.geometry.bounds, origin, direction);
      }
      if (!distance3) return;
      if (!mesh.hit) mesh.hit = { localPoint: new Vec3() };
      mesh.hit.distance = distance3;
      mesh.hit.localPoint.copy(direction).multiply(distance3).add(origin);
      hits.push(mesh);
    });
...
var Post = class {
  ...
  addPass({
    vertex: vertex3 = defaultVertex,
    fragment: fragment3 = defaultFragment,
    uniforms = {},
    textureUniform = "tMap",
    enabled = true
  } = {}) {
...
var GPGPU = class {
  ...
  addPass({
    vertex: vertex3 = defaultVertex2,
    fragment: fragment3 = defaultFragment2,
    uniforms = {},
    textureUniform = "tMap",
    enabled = true
  } = {}) {
...
var TextureLoader = class {
  static load(gl2, {
    ...
    switch (ext) {
      ...
      case "png":
        ...
        this.loadImage(gl2, src, texture);
        break;
      default:
  ...
  static getSupportedExtensions(gl2) {
    ...
    const extensions = {
      pvrtc: gl2.renderer.getExtension("WEBGL_compressed_texture_pvrtc"),
      s3tc: gl2.renderer.getExtension("WEBGL_compressed_texture_s3tc"),
