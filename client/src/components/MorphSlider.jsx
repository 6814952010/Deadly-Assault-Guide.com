...
void main() {
  ...
  // apply vertical center offset in pixels (positive moves image down)
  uv.y += uOffset / max(uResolution.y, 1.0);
...
class MorphEngine {
  constructor(container, { items, startIndex, reducedMotion, getOptions, onIndexChange, dprCap }) {
    ...
    // Full-screen triangle geometry (3 vertices) to cover the viewport
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        ...
        uOffset: { value: opts.centerOffset || 0 }
      }
    });
  ...
  syncOptions() {
    ...
    this.program.uniforms.uOffset.value = opts.centerOffset || 0;
  }
...
export default function MorphSlider({
  ...
  optsRef.current = { transition, duration, ease, intensity, scale, aberration, drift, overlayColor, loop, centerOffset };
